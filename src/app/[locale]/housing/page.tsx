...
export function generateMetadata() {
  return generateMetadataForPath("/housing");
}

export default async function Page() {
  const contentRoot = path.join(process.cwd(), "src", "content");
  const pageContent = loadPageContent(contentRoot, "housing");
  return <HubPageTemplate path="/housing" bodyHtml={pageContent?.bodyHtml} />;
}
