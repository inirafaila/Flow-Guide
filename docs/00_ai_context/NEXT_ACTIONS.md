...
**Slice 4.5 — SEO** (metadata, sitemap, robots) per [`EXECUTION_ROADMAP.md`](../05_execution/EXECUTION_ROADMAP.md). Do **not** bundle dashboard expansion unless explicitly approved.
