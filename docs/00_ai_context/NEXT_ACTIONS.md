...
**Slice 4.4 — Analytics (Plausible funnel events)** per [`EXECUTION_ROADMAP.md`](../05_execution/EXECUTION_ROADMAP.md). Do **not** bundle SEO or dashboard expansion unless explicitly approved.
